...
contextBridge.exposeInMainWorld("desktopShell", {
  ...
  renameSticker: (payload) => ipcRenderer.invoke("desktop:rename-sticker", payload),
  deleteSticker: (stickerId) => ipcRenderer.invoke("desktop:delete-sticker", stickerId),
  moveSticker: (payload) => ipcRenderer.invoke("desktop:move-sticker", payload),
